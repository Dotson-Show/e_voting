package com.evoter.permission.service.implementation;
...
import com.evoter.permission.enums.PermissionName;
import com.evoter.permission.enums.PermissionType;
import com.evoter.permission.model.Permission;
import com.evoter.permission.repository.PermissionRepository;
...
//    @Override
//    public List<Permission> getPermissionsByPermissionType2(PermissionType permissionType) {
//        if (permissionType.equals(PermissionType.SUPER)) {
//            return permissionRepository.findBySuperAdminFalse();
//        } else {
//            return permissionRepository.findByUserATrue();
//        }
//    }
